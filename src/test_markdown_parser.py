...
class TestMarkdownParser(unittest.TestCase):
    ...
    def test_split_nodes_delimitter(self):
        ...
        # Should raise value error, invalid text type.       
        text_node16 = split_nodes_delimitter([TextNode("This isn't right...", "uhoh")], "uhoh", TEXT_TYPE_TEXT)
        ...
        self.assertRaises(ValueError, text_node16.split_nodes_delimitter)
